...
# imf = emd_decomp(feature)
# new_signal = np.sum(imf.T, axis=0)
# print(imf.shape)
# plt.plot(new_signal)
# plt.show()
...
# graphEMDModeSpectrums(feature, 'EMDModeSpectrums.pdf')
# graphVMDModeSpectrums(feature, 'VMDModeSpectrums.pdf')
